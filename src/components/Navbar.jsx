    ...
    <div className="app-container">
      <div className="sidebar">
        ...
        <ul className="rotated-links">
          <li className="rotated-link-item"><Link to="/"><span>Home</span></Link></li>
          <li className="rotated-link-item"><Link to="/Loginpage"><span>Events</span></Link></li>
          <li className="rotated-link-item"><Link to="/Loginpage"><span>About</span></Link></li>
          <li className="rotated-link-item"><a href="/Loginpage"><span>Contact</span></a></li>
